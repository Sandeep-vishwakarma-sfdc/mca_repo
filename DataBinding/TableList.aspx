...
<body>
    ...
    <div>
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:masterConnectionString %>" SelectCommand="Select name from sys.tables"></asp:SqlDataSource>
        <br />
        <br />
        List of Table :
